...
interface SettingsPanelProps {
  ...
  activeTab: 'subtitle' | 'global' | 'project' | 'speakers' | 'assets';
...
export function SettingsPanel({ 
  ...
  const speakerJumpSections = [
    ...
    { id: 'speaker-pose', label: '气泡位置' },
    { id: 'speaker-typography', label: t('speakers.typography') },
    { id: 'speaker-name', label: t('speakers.name') },
  ...
  const visibleSettingsSections = activeTab === 'project'
    ? projectJumpSections
    : activeTab === 'speakers' && speakerSubTab === 'speakers' && currentSpeakerTab
      ? speakerJumpSections
      : [];
  ...
  return (
    <div className={`relative h-full flex flex-col overflow-hidden ${bgClass} [&_.text-xs]:text-sm`} style={{ backgroundColor: uiTheme.panelBg, color: uiTheme.textMuted, borderColor: uiTheme.border }}>
      ...
      <div ref={scrollContainerRef} className={`flex-1 overflow-y-auto custom-scrollbar ${activeTab === 'speakers' ? 'px-4 pb-4 pt-0' : activeTab === 'subtitle' ? 'p-0' : 'p-4'}`}>
        ...
        {activeTab === 'assets' && (
          <div className="space-y-4">
               <div className="rounded-xl border p-3 space-y-3 shadow-sm" style={{ borderColor: uiTheme.border, backgroundColor: uiTheme.cardBg, boxShadow: `0 6px 18px ${uiTheme.shadow}` }}>
                ...
                <div className="flex items-center gap-2">
                   <button type="button" onClick={() => addBackgroundSlide('image')} className="flex items-center gap-2 px-4 py-2 rounded-lg border text-xs font-medium transition-all duration-300" style={{ borderColor: uiTheme.border, backgroundColor: uiTheme.panelBgSubtle, color: secondaryThemeColor, boxShadow: `0 0 12px ${themeColor}44` }} onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = `${secondaryThemeColor}14`; e.currentTarget.style.boxShadow = `0 0 20px ${themeColor}66, 0 0 40px ${themeColor}22`; }} onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = uiTheme.panelBgSubtle; e.currentTarget.style.boxShadow = `0 0 12px ${themeColor}44`; }}>
                    <ImageIcon size={16} /> {t('project.addImageAsset')}
                  </button>
                  <button type="button" onClick={() => addBackgroundSlide('text')} className="flex items-center gap-2 px-4 py-2 rounded-lg border text-xs font-medium transition-all duration-300" style={{ borderColor: uiTheme.border, backgroundColor: uiTheme.panelBgSubtle, color: themeColor, boxShadow: `0 0 12px ${secondaryThemeColor}44` }} onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = `${themeColor}14`; e.currentTarget.style.boxShadow = `0 0 20px ${secondaryThemeColor}66, 0 0 40px ${secondaryThemeColor}22`; }} onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = uiTheme.panelBgSubtle; e.currentTarget.style.boxShadow = `0 0 12px ${secondaryThemeColor}44`; }}>
                    ...
                    {currentBackgroundSlide ? (
                      <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <div className="space-y-1.5">
                            <span className="text-xs opacity-70 inline-flex items-center gap-1">
                              {t('project.insertImageLayer')}
                              <Tooltip content={t('project.insertImageLayerTip')} placement="bottom" width={240} backgroundColor={isDarkMode ? 'rgba(17, 24, 39, 0.78)' : 'rgba(255, 255, 255, 0.78)'} borderColor={`${secondaryThemeColor}33`} textColor={uiTheme.text}>
                                <span className="inline-flex h-4 w-4 cursor-help items-center justify-center rounded-full border text-[0.625rem] font-semibold" style={{ borderColor: `${secondaryThemeColor}66`, color: secondaryThemeColor, backgroundColor: `${secondaryThemeColor}14` }}>?</span>
                              </Tooltip>
                            </span>
                        ...
                        {currentBackgroundSlide.type !== 'text' ? (
                          <div className="space-y-2">
                            <div className="rounded-lg border p-2.5 space-y-2" style={{ borderColor: uiTheme.border, backgroundColor: uiTheme.panelBgSubtle }}>
                            <div className="grid grid-cols-2 gap-3">
                              <div className="space-y-1.5">
        ...
        {activeTab === 'speakers' && speakerSubTab === 'speakers' && (
          <div className="space-y-4">
            {/* Speakers */}
            <div className="space-y-2">
              ...
              <div className="space-y-3">
                ...
                {currentSpeakerTab && config.speakers[currentSpeakerTab] && (() => {
                  ...
                  return (
                    ...
                    {/* Name */}
                    <div ref={registerSettingsSection('speaker-name')} className="space-y-2">
                      <span className="text-xs font-semibold flex items-center gap-1 opacity-80"><User size={12} /> {t('speakers.name')}</span>
                      <div className="space-y-1">
        ...
        {activeTab === 'speakers' && speakerSubTab === 'annotation' && config.speakers?.ANNOTATION && (
