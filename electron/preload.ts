...
contextBridge.exposeInMainWorld('electron', {
  ...
  persistPresetAvatar: (payload: { value: string; projectFilePath?: string | null; preferredName?: string }) => ipcRenderer.invoke('persist-preset-avatar', payload),
  ...
  renderSvgDataUrlToPng: (payload: { dataUrl: string; width: number; height: number }) => ipcRenderer.invoke('render-svg-data-url-to-png', payload),
  renderHtmlToPng: (payload: { html: string; width: number; height: number; scale?: number }) => ipcRenderer.invoke('render-html-to-png', payload),
